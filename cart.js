...
document.addEventListener('DOMContentLoaded', () => {
        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
            ...
            <button type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
              title="Remove item" onclick="prod_delete(${element.id})">
  ...
  function prod_delete (id) {
    ...
    const del_prod = products.filter((val,ind)=>val.id!=id)
    // const del_prod_1=JSON.parse(window.localStorage.getItem('cart'))
    // window.localStorage.removeItem(del_prod_1)
    // console.log(del_prod_1)
    window.localStorage.setItem('cart',JSON.stringify(del_prod))
    window.location.assign(window.location.href)
  }

  // JSON.parse(window.localStorage.getItem('prod_id'));